...
export FREESURFER_HOME=/cluster/projects/p23/tools/mri/freesurfer/freesurfer.6.0.1
                ...
                if [ $type != "label" ]; then
                    montage -mode concatenate -background transparent \
                     ...
                     montage -mode concatenate -background transparent -crop 500x350+50+125 -tile x1 \
                            ...
                            figures/report_${figure_type}_${type}_${base_name}_${measure}_th00.png

                    montage -mode concatenate -background transparent \
                        figures/report_${figure_type}_${type}_${base_name}_${measure}_th00.png figures/bar.png \
                        figures/report_${figure_type}_${type}_${base_name}_${measure}_th00.png
                fi
            fi
        done
            ...
            do
                ...
                if [ $(ls figures/${figure_type}/${type}/sig.*th${th}*${measure}*.png | wc -l) -gt 1 ]; then
                    ...
                    if [ $type != "label" ]; then
                        ...
                        montage -mode concatenate -background transparent \
                            figures/report_${figure_type}_${type}_${base_name}_${measure}_th${th}.png figures/bar.png \
                            figures/report_${figure_type}_${type}_${base_name}_${measure}_th${th}.png
