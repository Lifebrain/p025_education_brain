...
lhmeasure = ['MEGA.lh.' measure '.' target '.sm' num2str(fwhm) '.mgh'];
rhmeasure = ['MEGA.rh.' measure '.' target '.sm' num2str(fwhm) '.mgh'];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% first check whether all necessary files exist
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if ~exist('MEGA.sorted.qdec.table.dat', 'file') || ~exist('MEGA.ni.mat', 'file')
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sortedqdec = fReadQdec('MEGA.sorted.qdec.table.dat');
